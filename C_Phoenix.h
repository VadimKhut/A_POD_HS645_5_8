...
extern void      ISD_Stop(void);
extern void      ISD_PlayFromADR(byte n_record, byte checkBusy);
...
//    boolean         FIsGPSeqDefined(uint8_t iSeq);
    ...
    void            OutputServoForHeadAbdomen(byte LegIndex, short sHeadAbdomenAngle1);
    void            OutputServoForMand(void);
